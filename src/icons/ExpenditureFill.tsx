...
const ExpenditureFillComponent = (
...
const ExpenditureFill = forwardRef(ExpenditureFillComponent);

ExpenditureFill.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

ExpenditureFill.displayName = 'ExpenditureFill';

export default ExpenditureFill;
