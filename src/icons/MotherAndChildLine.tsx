...
const MotherAndChildLineComponent = (
...
const MotherAndChildLine = forwardRef(MotherAndChildLineComponent);

MotherAndChildLine.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

MotherAndChildLine.displayName = 'MotherAndChildLine';

export default MotherAndChildLine;
