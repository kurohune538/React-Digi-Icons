...
const ExpenditureLineComponent = (
...
const ExpenditureLine = forwardRef(ExpenditureLineComponent);

ExpenditureLine.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

ExpenditureLine.displayName = 'ExpenditureLine';

export default ExpenditureLine;
