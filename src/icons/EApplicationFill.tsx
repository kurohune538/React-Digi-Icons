...
const EApplicationFillComponent = (
...
const EApplicationFill = forwardRef(EApplicationFillComponent);

EApplicationFill.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

EApplicationFill.displayName = 'EApplicationFill';

export default EApplicationFill;
