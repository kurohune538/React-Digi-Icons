...
const CertificationWithSealLineComponent = (
...
const CertificationWithSealLine = forwardRef(
  CertificationWithSealLineComponent
);

CertificationWithSealLine.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

CertificationWithSealLine.displayName = 'CertificationWithSealFill';

export default CertificationWithSealLine;
